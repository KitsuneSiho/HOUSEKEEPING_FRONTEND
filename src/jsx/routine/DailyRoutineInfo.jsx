    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.tabs}>
                <div className={`${styles.tab} ${styles.active}`} onClick={() => navigate('/routine/daily')}>일간</div>
                <div className={styles.tab} onClick={() => navigate('/routine/weekly')}>주간</div>
            ...
            <div className={styles.routineContainer}>
                <div className={styles.roomRoutine}>
                    <div className={styles.roomRoutineHeader}>
                        ...
                        <div className={styles.alramOnOff}>
                            <p>모든 알림 켜기</p>
                            <img src="/lib/plus.svg" alt="plus" className={styles.plusIcon} onClick={() => addRoutineItem('roomRoutine')} />
                        </div>
                    </div>
                ...
                <div className={styles.livingRoomRoutine}>
                    <div className={styles.livingRoomRoutineHeader}>
                        ...
                        <div className={styles.alramOnOff}>
                            <p>모든 알림 켜기</p>
                            <img src="/lib/plus.svg" alt="plus" className={styles.plusIcon} onClick={() => addRoutineItem('livingRoomRoutine')} />
                        </div>
                    </div>
                ...
                <div className={styles.toiletRoutine}>
                    <div className={styles.toiletRoutineHeader}>
                        ...
                        <div className={styles.alramOnOff}>
                            <p>모든 알림 켜기</p>
                            <img src="/lib/plus.svg" alt="plus" className={styles.plusIcon} onClick={() => addRoutineItem('toiletRoutine')} />
                        </div>
                    </div>
