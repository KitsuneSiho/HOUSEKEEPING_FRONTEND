    ...
    return (
        <div>
            <div className="footer">
                ...
                <img className="chatIcon" src="/lib/채팅아이콘.svg" alt="Chat Icon" onClick={() => navigate('/chatList')} />
            ...
            <div id="popup" className="popup" style={{ display: popupVisible ? 'flex' : 'none' }}>
                ...
                <img className="livingRoom" src="/lib/냉장고.svg" alt="냉장고 아이콘" onClick={() => navigate('/livingRoom')} />
